...
public class TestMemoryChannel {
	...
	public static void main(String[] args) throws Exception{
		TestMemoryChannel test = new TestMemoryChannel();
		test.setUp();
		test.testPutTake();
	}
	...
	public void testPutTake() throws InterruptedException, EventDeliveryException {
		...
		System.out.println(new String(event2.getBody()));
		transaction.commit();
	}
	...
	public void testChannelResize() {
		...
		/*
		 * Reconfigure capacity down and add another event, shouldn't result in
		 * exception
		 */
		...
		/*
		 * Attempt to reconfigure capacity to below current entry count and
		 * verify it wasn't carried out
		 */
