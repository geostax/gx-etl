...
import com.geostax.etl.annotations.Recyclable;
import com.geostax.etl.instrumentation.ChannelCounter;
 ...
 * disk is impractical is required or durability of data is not required.
 * </p>
 * <p>
...
public class MemoryChannel extends BasicChannelSemantics {
	...
	public void configure(Context context) {
		...
		try {
			...
			LOGGER.warn("Invalid transation capacity specified, initializing channel" + " to default capacity of {}",
