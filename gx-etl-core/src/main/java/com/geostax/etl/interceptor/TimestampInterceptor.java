 ...
 * "timestamp" by default and its format is a "stringified" long timestamp in
 * milliseconds since the UNIX epoch. The name of the header can be changed
 * through the configuration using the config key "header".
 */
