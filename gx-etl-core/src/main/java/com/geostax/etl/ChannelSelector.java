...
/**
 * <p>
 * Allows the selection of a subset of channels from the given set based on its
 * implementation policy. Different implementations of this interface embody
 * different policies that affect the choice of channels that a source will push
 * the incoming events to.
 * </p>
 */
