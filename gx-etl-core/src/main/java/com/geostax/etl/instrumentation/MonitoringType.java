...
package com.geostax.etl.instrumentation;
...
public enum MonitoringType {
  OTHER(null),
  GANGLIA(com.geostax.etl.instrumentation.GangliaServer.class),
  HTTP(com.geostax.etl.instrumentation.http.HTTPMetricsServer.class);
