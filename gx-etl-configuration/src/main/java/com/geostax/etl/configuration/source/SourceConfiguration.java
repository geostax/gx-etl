 ...
 * the License.
 */
package com.geostax.etl.configuration.source;
...
import com.geostax.etl.configuration.ComponentConfigurationFactory;
...
import com.geostax.etl.configuration.channel.ChannelSelectorType;
...
public class SourceConfiguration extends ComponentConfiguration {
	...
	public void configure(Context context) throws ConfigurationException {
		...
		try {
			...
			if (channels.isEmpty()) {
				errors.add(new FlumeConfigurationError(componentName, ComponentType.CHANNEL.getComponentType(),
			...
			Map<String, String> selectorParams = context
