...
import com.geostax.etl.configuration.channel.ChannelConfiguration;
import com.geostax.etl.configuration.channel.ChannelType;
...
import com.geostax.etl.configuration.sink.SinkType;
import com.geostax.etl.configuration.source.SourceConfiguration;
import com.geostax.etl.configuration.source.SourceType;
...
public class FlumeConfiguration {
  ...
  //name 会被分解为两部分：agentName和configKey
  //此方法的目的是产生 AgentConfiguration，并赋予它所有与次Agent相关的属性，然后加入到agentConfigMap中
